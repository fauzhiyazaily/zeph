  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-10 sm:px-8">
      ...
      <section className="glass-card soft-fade-in relative w-full max-w-4xl overflow-hidden rounded-3xl p-8 sm:p-12">
        <div className="absolute right-0 top-0 h-28 w-28 -translate-y-1/3 translate-x-1/4 rounded-full border border-slate-300/40 bg-slate-950/30" />

        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200/90">Zeph</p>
        <h1 className="mt-4 max-w-3xl text-4xl font-semibold leading-tight text-slate-100 sm:text-5xl">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            href="/sign-in"
            className="inline-flex items-center justify-center rounded-xl border border-slate-400/40 bg-slate-950/30 px-5 py-2.5 font-semibold text-slate-100 hover:-translate-y-0.5 hover:bg-slate-900/55"
          >
        ...
        <div className="mt-8 grid gap-3 text-sm sm:grid-cols-3">
          <div className="rounded-xl border border-slate-300/35 bg-slate-950/30 px-4 py-3 text-slate-200">
